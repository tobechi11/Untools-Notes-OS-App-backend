...
const SAMPLE_MEMOS = [
  {
    ...
    tiptapJson: {
      ...
      content: [
        ...
        p([node("ReviewDate", "Apr 1, 2026"), " — revisit after Safaricom term sheet decision"]),
